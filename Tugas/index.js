const tripleTrouble = (one, two, three) => {
  ...
  // let arrText = one.concat(two).concat(three).split('')
  // let textA = ''
  // let textB = ''
  // arrText.forEach( (huruf, index) => {
  //   if (index % 2 == 0){
  //     textA += huruf
  //   } else {
  //     textB += huruf
...
//   let hasilGanjil = "";
//   let kataGanjil = string.split("");
//   for (let i = 0; i < kataGanjil.length; i++) {
//     if (i % 2 == 0) {
//       hasilGanjil += kataGanjil[i].toUpperCase()
//     } else {
//       hasilGanjil += kataGanjil[i]
//     }
//   }
//   return hasilGanjil
// };
// console.log(altCaps("ayam"))
